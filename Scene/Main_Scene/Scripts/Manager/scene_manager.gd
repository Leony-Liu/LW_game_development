...
func _load_single_scene(scene_name: String) -> void:
	...
	# 4. 播放转场动画
	_interlude_animation()


# 黑屏过渡，并执行换场景或者开UI的逻辑
func _interlude_animation( duration: float = 0.3) -> void:
