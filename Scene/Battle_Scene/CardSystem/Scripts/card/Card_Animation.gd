...
func update_dynamic_rotation(delta: float, offset_x: float, card_width: float) -> void:
	...
	visual_root.rotation_degrees = lerp(
		visual_root.rotation_degrees,
		target_rotation,
		weight
	)
...
func play_hover_enter() -> void:
	...
	hover_tween.tween_property(
		visual_root,
		"position",
		original_visual_position + Vector2.UP * hover_lift,
...
func play_card_played() -> void:
	...
	action_tween.tween_property(
		visual_root,
		"position",
		original_visual_position + Vector2.UP * play_y_offset,
		play_duration
	)
	...
	action_tween.tween_property(
		visual_root,
		"scale",
		original_visual_scale * play_scale,
		play_duration
	)
...
func play_discard() -> void:
	...
	action_tween.tween_property(
		visual_root,
		"position",
		original_visual_position + Vector2.DOWN * absf(discard_y_offset),
		discard_duration
	)
	...
	action_tween.tween_property(
		visual_root,
		"scale",
		original_visual_scale * discard_scale,
		discard_duration
	)
	...
	action_tween.tween_property(
		visual_root,
		"rotation_degrees",
		original_visual_rotation + discard_rotation,
		discard_duration
	)
